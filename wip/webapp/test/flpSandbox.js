		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Wip TimeEntry",
									"targetURL": "#comchappotawip-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotawip-display": {
								"semanticObject": "comchappotawip",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.wip",
									"url": sap.ui.require.toUrl("com/chappota/wip")
								}
							}
						}
					}
